...
node {
    stage("REG Action") {
        try {
            ...
            def response = httpRequest url: baseUrl + "/outmall/batch/batchproc.asp?mallid=ssg&apiAction=REG&topN=50",
            ...
            if (responseText != ""){
                ...
                for(i=0; i < responseTextArr.length; i++){
                    ...
                    def responseProc = httpRequest url: baseUrl + "/outmall/proc/ssgProc.asp?redSsnKey=system&jenkinsBatchYn=Y&mallid=ssg&action=REG&idx="+idxArr+"&itemid="+itemArr,
                                            validResponseCodes: "200:499"
