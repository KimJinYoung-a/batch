...
node {
    stage("Confirm Action") {
        try {
            ...
            def response = httpRequest url: baseUrl + "/outmall/batch/batchproc.asp?mallid=shintvshopping&apiAction=CONFIRM&topN=100",
            ...
            if (responseText != ""){
                ...
                for(i=0; i < responseTextArr.length; i++){
                    ...
                    def responseProc = httpRequest url: baseUrl + "/outmall/proc/shintvshoppingProc.asp?redSsnKey=system&jenkinsBatchYn=Y&mallid=shintvshopping&action=CONFIRM&idx="+idxArr+"&itemid="+itemArr,
                                            validResponseCodes: "200:499"
