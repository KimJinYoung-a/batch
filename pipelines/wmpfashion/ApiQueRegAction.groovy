...
node {
    stage("REG Action") {
        try {
            ...
            def response = httpRequest url: baseUrl + "/outmall/batch/batchproc.asp?mallid=wmpfashion&apiAction=REG&topN=100",
            ...
            if (responseText != ""){
                ...
                for(i=0; i < responseTextArr.length; i++){
                    ...
                    def responseProc = httpRequest url: baseUrl + "/outmall/proc/wmpfashionProc.asp?redSsnKey=system&jenkinsBatchYn=Y&mallid=wmpfashion&action=REG&idx="+idxArr+"&itemid="+itemArr,
                                            validResponseCodes: "200:499"
