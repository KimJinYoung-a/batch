...
node {
   stage("Chkstat1 Action") {
        try {
            ...
            def response = httpRequest url: baseUrl + "/outmall/batch/batchproc.asp?mallid=coupang&apiAction=CHKSTAT&topN=80",
            ...
            if (responseText != ""){
                ...
                for(i=0; i < responseTextArr.length; i++){
                    ...
                    def responseProc = httpRequest url: baseUrl + "/outmall/proc/coupangProc.asp?redSsnKey=system&jenkinsBatchYn=Y&mallid=coupang&action=CHKSTAT&idx="+idxArr+"&itemid="+itemArr,
                                            validResponseCodes: "200:499"
