...
node {
    stage("Chkstat Action1") {
        try {
            ...
            def response = httpRequest url: baseUrl + "/outmall/batch/batchproc.asp?mallid=lotteon&apiAction=CHKSTAT&topN=70",
            ...
            if (responseText != ""){
                ...
                for(i=0; i < responseTextArr.length; i++){
                    ...
                    def responseProc = httpRequest url: baseUrl + "/outmall/proc/LotteonProc.asp?redSsnKey=system&jenkinsBatchYn=Y&mallid=lotteon&action=CHKSTAT&idx="+idxArr+"&itemid="+itemArr,
                                            validResponseCodes: "200:499"
