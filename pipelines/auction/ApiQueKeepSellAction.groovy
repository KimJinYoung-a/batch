...
node {
    stage("KeepSell Action") {
        try {
            ...
            def response = httpRequest url: baseUrl + "/outmall/batch/batchproc.asp?mallid=auction1010&apiAction=KEEPSELL&topN=150",
            ...
            if (responseText != ""){
                ...
                for(i=0; i < responseTextArr.length; i++){
                    ...
                    def responseProc = httpRequest url: baseUrl + "/outmall/proc/AuctionProc.asp?redSsnKey=system&jenkinsBatchYn=Y&mallid=auction1010&action=KEEPSELL&idx="+idxArr+"&itemid="+itemArr,
                                            validResponseCodes: "200:499"
