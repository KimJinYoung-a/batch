...
node {
    stage("EDITBATCH Action") {
        try {
            ...
            def response = httpRequest url: baseUrl + "/outmall/batch/batchproc.asp?mallid=auction1010&apiAction=SOLDOUT&topN=100",
//            def response = httpRequest url: baseUrl + "/outmall/batch/batchproc.asp?mallid=auction1010&apiAction=EDITBATCH&topN=100",
