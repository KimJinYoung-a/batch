...
node {
    stage("DELETE1 Action") {
        try {
            def baseUrl = "http://wapi.10x10.co.kr"
            def response = httpRequest url: baseUrl + "/outmall/batch/batchproc.asp?mallid=Mylittlewhoopee&apiAction=DEL&topN=100",
            ...
            if (responseText != ""){
                ...
                for(i=0; i < responseTextArr.length; i++){
                    ...
                    def responseProc = httpRequest url: baseUrl + "/outmall/proc/MylittlewhoopeeProc.asp?redSsnKey=system&jenkinsBatchYn=Y&mallid=Mylittlewhoopee&action=DEL&idx="+idxArr+"&itemid="+itemArr,
                                            validResponseCodes: "200:499"
