...
node {
    stage("DELETE1 Action") {
        try {
            ...
            def response = httpRequest url: baseUrl + "/outmall/batch/batchproc.asp?mallid=nvstorefarm&apiAction=DEL&topN=100",
            ...
            if (responseText != ""){
                ...
                for(i=0; i < responseTextArr.length; i++){
                    ...
                    def responseProc = httpRequest url: baseUrl + "/outmall/proc/NvstorefarmProc.asp?redSsnKey=system&jenkinsBatchYn=Y&mallid=nvstorefarm&action=DEL&idx="+idxArr+"&itemid="+itemArr,
                                            validResponseCodes: "200:499"
