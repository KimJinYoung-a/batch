...
node {
    stage("REG Action1") {
        try {
            ...
            def response = httpRequest url: baseUrl + "/outmall/batch/batchproc.asp?mallid=lfmall&apiAction=REG&topN=100",
            ...
            if (responseText != ""){
                ...
                for(i=0; i < responseTextArr.length; i++){
                    ...
                    def responseProc = httpRequest url: baseUrl + "/outmall/proc/lfmallProc.asp?redSsnKey=system&jenkinsBatchYn=Y&mallid=lfmall&action=REG&idx="+idxArr+"&itemid="+itemArr,
                                            validResponseCodes: "200:499"
